            ...
            if (checkResult.IsFailure)
            {
                ...
                if (checkSkuAvailabilitySearchFilterError.SkuAvailabilityId.IsFailure)
                {
                    ...
                    if (checkSkuAvailabilityIdError.SupplierId.IsFailure)
                        return ErrorBuilder.CreateInvalidBusinessRuleWithDefaultMessage(nameof(Domain.ValueObjects.SkuAvailabilitySearchFilter.SkuAvailabilityId.SupplierId));

                    if (checkSkuAvailabilityIdError.SupplierSkuId.IsFailure)
                        return ErrorBuilder.CreateInvalidBusinessRuleWithDefaultMessage(nameof(Domain.ValueObjects.SkuAvailabilitySearchFilter.SkuAvailabilityId.SupplierSkuId));

                    if (checkSkuAvailabilityIdError.ContractId.IsFailure)
                        return ErrorBuilder.CreateInvalidBusinessRuleWithDefaultMessage(nameof(Domain.ValueObjects.SkuAvailabilitySearchFilter.SkuAvailabilityId.ContractId));
                }

                if (checkSkuAvailabilitySearchFilterError.PersistedSkuId.IsFailure)
                    return ErrorBuilder.CreateInvalidBusinessRuleWithDefaultMessage(nameof(Domain.ValueObjects.SkuAvailabilitySearchFilter.PersistedSkuId));

                if (checkSkuAvailabilitySearchFilterError.ShardId.IsFailure)
                    return ErrorBuilder.CreateInvalidBusinessRuleWithDefaultMessage(nameof(Domain.ValueObjects.SkuAvailabilitySearchFilter.ShardId));
