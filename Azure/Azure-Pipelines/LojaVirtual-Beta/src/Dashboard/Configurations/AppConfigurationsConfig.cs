...
namespace Dashboard.Web.Configurations
{
    internal static class AppConfigurationsConfig
    {
        ...
        private static void WorkarroundSanitizeDuplicatedConfigurationSources(this IConfigurationBuilder config)
        {
            ...
            removeDuplicated<Microsoft.Extensions.Configuration.Json.JsonConfigurationSource, string>(duplicateds, x => x.Path);
            removeDuplicated<Microsoft.Extensions.Configuration.EnvironmentVariables.EnvironmentVariablesConfigurationSource, string>(duplicateds, x => x.Prefix);
        }
    }
}
