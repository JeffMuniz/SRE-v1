...
Elastic Logstach Kibana yaml kubernetes deploy
#!
eks-bootstrapper  - Has AWS services eks

elk-elogbana-beat - Has a gathering of Elastic Logstash Kibana using beats

k8s-infra - is about constructing k8s directly via yaml and some arch
...
$To Validate JetBrains BFG Fortify

![My Image](imagine/comoSerDevops.jfif)
![My Image](imagine/learn-k8s.png)
![My Image](imagine/k8s-arch.jpeg)
![My Image](imagine/solucao-istio-aws.jpg)



#From Original Source Bellow at https://github.com/elastic/beats
