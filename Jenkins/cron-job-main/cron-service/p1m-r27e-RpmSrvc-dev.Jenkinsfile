pipeline {
    ...
    parameters {
        ...
        def url_repo = "http://nexus.macna.local/service/rest/v1/search?" +
             ...
             "&maven.artifactId=reposicao-medicamento-service" +
             "&maven.extension=jar"
    ...
    environment
    {
        ...
        APPLICATION_NAME='repomedservice'
        REPO_NEXUS="reposicao-medicamento-service"
        JKS_PRODUCT = "pbm"
        ...
        CRONJOB_YAML = "yaml/cronjob-service-DEV.yml"
