...
smtp_starttls = False
smtp_ssl = True
smtp_user = jmuniz1985@gmail.comr                      
smtp_password =  some-crde-passin
smtp_port = 465
smtp_mail_from = jmuniz1985@gmail.comr 
...
with DAG(
    ...
    t1 = WinRMOperator(
        task_id="fipreclose",
        command='C:\CMDFI\FICLOSE\fipreclose.bat',
        winrm_hook=winRMHook
        )
    t2 = WinRMOperator(
        task_id="mailfipreclose", command='C:\CMDFI\FICLOSE\mfimove.bat',
        winrm_hook=winRMHook
        )
    t3 = WinRMOperator(
        task_id="ficlose",
        command='C:\CMDFI\FICLOSE\ficlose.bat',
        winrm_hook=winRMHook
        )
    t4 = WinRMOperator(
        task_id="mailficlose", command='C:\CMDFI\FICLOSE\mfimove.bat',
        winrm_hook=winRMHook
        )
    t5 = WinRMOperator(
        task_id="fibigsend",
    ...
    t6 = WinRMOperator(
        task_id="mailfibigsend", command='C:\CMDFI\FICLOSE\mfimove.bat',
        winrm_hook=winRMHook
        )
